      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h3 className="text-lg font-medium text-neutral-800 mb-1">Student Database</h3>
              <p className="text-neutral-600 text-sm">View and manage all student records</p>
            </div>
              ...
              <Table>
                ...
                <TableHeader className="sticky top-0 bg-white z-10">
                  <TableRow>
                    ...
                    <TableHead>Clear Cover</TableHead>
                    <TableHead>Photo Pockets</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {filteredStudents?.length ? (
                    filteredStudents.map((student) => (
                      <TableRow key={student.id}>
                        ...
                        <TableCell>{student.clearCover ? 'Yes' : 'No'}</TableCell>
                        <TableCell>{student.photoPockets ? 'Yes' : 'No'}</TableCell>
                      </TableRow>
                    ))
                  ) : (
                    <TableRow>
                      <TableCell colSpan={11} className="text-center py-8 text-neutral-500">
                        No students found. Add students or import from CSV.
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
